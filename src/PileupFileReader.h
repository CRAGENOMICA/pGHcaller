...
#ifndef PILEUPFILEREADER_H_
#define PILEUPFILEREADER_H_

#include "PileupFile.h"

namespace ngh {

class PileupFileReader : public ngh::PileupFile {
public:
    PileupFileReader();
    virtual ~PileupFileReader();

    void readBuffer(const Chunk& chunk);
};

} /* namespace ngh */

#endif /* PILEUPFILEREADER_H_ */
