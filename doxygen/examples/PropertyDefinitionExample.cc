...
bool AdvanceSpeculativeLoadProp::condition(){
	return ( storesALAT > 0);
}

double AdvanceSpeculativeLoadProp::confidence(){
	return 1.0;
}

double AdvanceSpeculativeLoadProp::severity(){
...
Gather_Required_Info_Type AdvanceSpeculativeLoadProp::get_required_info(){
